...
<p align="center">
  <strong>专为教育场景下 Vibe Coding 开发的 AI IDE</strong>
</p>
...
XFXCode Project 是 XFXCode 的公开下载与发布说明仓库。XFXCode 是一款专为 **教育场景下 Vibe Coding** 开发的 AI IDE：它把传统代码编辑器、AI Agent、工具调用、项目文件操作、技能系统和治理审计整合在一个桌面应用中，让学生和教师可以在真实工程环境里完成 AI 辅助编程、vibe coding 编程教学、作品创作和代码学习。
...
| 维度 | XFXCode 提供的能力 |
| --- | --- |
| 面向对象 | 教育场景下的 Vibe Coding、AI 编程教学与创新项目实践 |
...
XFXCode Project is the public download and release-notes repository for XFXCode, a desktop AI IDE built for vibe coding in educational scenarios.
